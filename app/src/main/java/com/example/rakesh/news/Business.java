...
public class Business extends Fragment {
    ...
    private View v;
   // private static final String URL_NAME ="https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=9ef3f3896c404b2eb232ad9a642c269b&pagesize=10";
private String URL_NAME ="https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=9ef3f3896c404b2eb232ad9a642c269b&pagesize=20";
    public Business() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        myrecyclerview = (RecyclerView) v.findViewById(R.id.business_recycler);
        int colnum;
                 ...
                 public void onResponse(String response) {
                     ...
                     try{
                         ...
                         for(int i =0;i<article.length();i++){
                             ...
                             if(ob.getString("urlToImage")!="null"){
