...
public class Entertainment extends Fragment {
    ...
    private View v;
    private static final String URL_NAME ="https://newsapi.org/v2/top-headlines?country=in&category=entertainment&apiKey=9ef3f3896c404b2eb232ad9a642c269b&pagesize=20";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        myrecyclerview = (RecyclerView) v.findViewById(R.id.entertainment_recycler);
        int colnum;
